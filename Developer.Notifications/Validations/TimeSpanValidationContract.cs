...
namespace Developer.Notifications.Validations
{
    public partial class Contract<T>
    {
        ...
        /// <returns></returns>
        public Contract<T> IsNull(TimeSpan? val, string message)
        {
            if (val == null)
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsNotNull(TimeSpan? val, string message)
        {
            if (val != null)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsGreaterThan(TimeSpan val, TimeSpan comparer, string message)
        {
            if (val > comparer)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsGreaterOrEqualsThan(TimeSpan val, TimeSpan comparer, string message)
        {
            if (val >= comparer)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsLowerThan(TimeSpan val, TimeSpan comparer, string message)
        {
            if (val < comparer)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsLowerOrEqualsThan(TimeSpan val, TimeSpan comparer, string message)
        {
            if (val <= comparer)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsMinValue(TimeSpan val, string message)
        {
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsNotMinValue(TimeSpan val, string message)
        {
            if (val != TimeSpan.MinValue)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsMaxValue(TimeSpan val, string message)
        {
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsNotMaxValue(TimeSpan val, string message)
        {
            if (val != TimeSpan.MaxValue)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> AreEquals(TimeSpan val, TimeSpan comparer, string message)
        {
            if (val == comparer)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> AreNotEquals(TimeSpan val, TimeSpan comparer, string message)
        {
            if (val != comparer)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsBetween(TimeSpan val, TimeSpan start, TimeSpan end, string message)
        {
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsNotBetween(TimeSpan val, TimeSpan start, TimeSpan end, string message)
        {
            if (val < start || val > end)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> Contains(TimeSpan val, IEnumerable<TimeSpan> list, string message)
        {
            if (list.Any(x => x == val))
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> NotContains(TimeSpan val, IEnumerable<TimeSpan> list, string message)
        {
            if (!list.Any(x => x == val))
                AddNotification((string)null, message);
