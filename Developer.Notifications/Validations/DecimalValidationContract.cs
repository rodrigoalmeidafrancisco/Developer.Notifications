...
namespace Developer.Notifications.Validations
{
    public partial class Contract<T>
    {
        ...
        /// <returns></returns>
        public Contract<T> IsNull(decimal? val, string message)
        {
            if (val == null)
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsNotNull(decimal? val, string message)
        {
            if (val != null)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsGreaterThan(decimal val, decimal comparer, string message)
        {
            if (val > comparer)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsGreaterOrEqualsThan(decimal val, decimal comparer, string message)
        {
            if (val >= comparer)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsLowerThan(decimal val, decimal comparer, string message)
        {
            if (val < comparer)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsLowerOrEqualsThan(decimal val, decimal comparer, string message)
        {
            if (val <= comparer)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsMinValue(decimal val, string message)
        {
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsNotMinValue(decimal val, string message)
        {
            if (val != decimal.MinValue)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsMaxValue(decimal val, string message)
        {
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsNotMaxValue(decimal val, string message)
        {
            if (val != decimal.MaxValue)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> AreEquals(decimal val, decimal comparer, string message)
        {
            if (val == comparer)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> AreNotEquals(decimal val, decimal comparer, string message)
        {
            if (val != comparer)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsBetween(decimal val, decimal start, decimal end, string message)
        {
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> IsNotBetween(decimal val, decimal start, decimal end, string message)
        {
            if (val < start || val > end)
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> Contains(decimal val, IEnumerable<decimal> list, string message)
        {
            if (list.Any(x => x == val))
                AddNotification((string)null, message);
        ...
        /// <param name="message">A mensagem de notificação (Custom notification message).</param>
        /// <returns></returns>
        public Contract<T> NotContains(decimal val, IEnumerable<decimal> list, string message)
        {
            if (!list.Any(x => x == val))
                AddNotification((string)null, message);
